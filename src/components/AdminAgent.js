...
- upload_brand_asset: Replace a brand visual by URL (admin must provide hosted URL). data: {brand_id, asset_type: 'logo'|'hero'|'product', file_url, sku?}
...
export default function AdminAgent() {
  ...
  const [messages, setMessages] = useState([
    { role: 'assistant', text: "Hi! I'm your Global Access admin assistant. I can update brand content, change site design (hero, colors, layouts), manage flavors, generate marketing emails, and more. What would you like to do?" }
  ]);
              ...
              <div key={i} style={msgStyle(msg.role)}>
                {msg.isConfirm ? (
                  <div style={{ maxWidth: '95%' }}>
                    ...
                    {pending && isDesignAction(pending.action) && (
