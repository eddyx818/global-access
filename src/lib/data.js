...
export const BRANDS = [
  {
    ...
    products: [
      { sku: "CL-MUSH-5000", name: "Mushroom 5,000mg", detail: "40 pieces/jar · 10 jars/case", orderUnit: "master_case", image: "/images/churros-locos/mushroom-horchata.jpeg",
        units_per_inner: 40, inner_unit_label: "pieces", inners_per_case: 10, inner_pack_label: "jar", retail_order_unit: "jar", retail_order_units: "jar", distributor_order_units: "jar, case",
